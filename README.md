...
<p>The final run was then executed using the bash script running_code.sh in a working directory, it calls tailored codes that can be found in this repository under /code/final_run. This script performs the following operations:
