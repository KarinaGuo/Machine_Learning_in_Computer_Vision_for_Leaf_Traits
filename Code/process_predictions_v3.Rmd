...
ref_result <- left_join(ref_result, lookup, by = "scientificName") %>% 
  ...
  # Removing outliers using the function identify_outliers from the package rstatix
...
```{r Plotting mean of traits across the spatial extent of Australia}
  # Creating the spatial object of Australia and plotting the mean traits across it 
